const servicos = [
    ...
    },
    {
        ...
        servico: 'Seguros',
        texto: `A VL Cred possui <strong>todos os tipos de seguros</strong> e <strong>mais de 10 seguradoras</strong> parceiras para melhor atender sua necessidade!`
    },
    {
        imagem: `//img.icons8.com/bubbles/100/check.png`,
        servico: 'Consórcios',
        texto: `A VL Cred oferece a <strong>melhor opção de consórcio</strong> de acordo com sua necessidade. Trabalhamos com todos os tipos de consórcios!`
    },
    {
    ...
    },
    {
        ...
        texto: `Está na hora de adquirir seu <strong>novo veículo</strong>! Com a VL Cred você tem as <strong>melhores taxas</strong> e opções de financiamento!`
    },
    {
        imagem: `//img.icons8.com/clouds/100/cottage.png`,
        servico: 'Financiamento Residencial',
        texto: `Está na hora de adquirir sua <strong>nova casa</strong>! Com a VL Cred você tem as <strong>melhores taxas</strong> e opções de financiamento e refinanciamento residencial!`
    },
    {
